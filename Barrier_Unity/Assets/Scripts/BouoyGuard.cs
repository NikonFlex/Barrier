...
public class BouoyGuard : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        ellipse_points = new List<GameObject>();
        for (int i = 0; i < 6; i++)
        {
            GameObject new_sphere = GameObject.CreatePrimitive(PrimitiveType.Sphere);
            new_sphere.transform.localScale = new Vector3(5, 5, 5);
            new_sphere.name = $"{i} point";
            ellipse_points.Add(new_sphere);
        }
    ...
    void Update()
    {
        ...
        ellipse_points[0].transform.position = c1;
        ellipse_points[1].transform.position = c2;
        ellipse_points[2].transform.position = c3;
        ellipse_points[3].transform.position = c4;
        ellipse_points[4].transform.position = new Vector3((c1.x + c3.x) / 2f, 10, (c1.z + c3.z) / 2f);
        ellipse_points[5].transform.position = new Vector3((c2.x + c4.x) / 2f, 10, (c2.z + c4.z) / 2f);
